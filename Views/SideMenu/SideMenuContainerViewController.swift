...
@objc public enum SideMenuPanMode: Int {
    case none
...
@objc public enum SideMenuState: Int {
    case closed
    case leftMenuOpen
    case rightMenuOpen
}
...
/// - willClose: 将要关闭
/// - didClose: 关闭动作刚结束
@objc public enum SideMenuStateEvent: Int {
    case willOpen
    case didOpen
    case willClose
    case didClose
...
/// - left: 左边
/// - right: 右边
private enum SideMenuPanDirection: Int {
    case none
    case left
    case right
}

public typealias SideMenuVoidBlock = () -> Void
fileprivate let SideMenuStateNotificationEvent = "SideMenuStateNotificationEvent"
...
open class SideMenuContainerViewController: UIViewController, UIGestureRecognizerDelegate {
            ...
            if newValue != nil {
                ...
                if sideMenuShadowEnabled == true {
                    if self.sideMenuShadow != nil {
                        ...
                        self.sideMenuShadow = SideMenuShadow.shadow(sdView: newValue!.view)
                    }
                }
    ...
    /// 拖动状态
    @objc public var sideMenuPanMode: SideMenuPanMode = .defaults {
        willSet {
    ...
    /// 设置当前菜单状态
    @objc public var sideMenuState: SideMenuState = .closed
    ...
    /// 侧滑阴影
    private var sideMenuShadow: SideMenuShadow?
    ...
    /// 拖动位置
    private var panGestureDirection: SideMenuPanDirection = .none
...
extension SideMenuContainerViewController {
    ...
    /// - Returns: self
    @objc open class func container(centerViewController: UIViewController?, leftMenuViewController: UIViewController?, rightMenuViewController: UIViewController?) -> SideMenuContainerViewController {
    ...
    ///   - rightMenuViewController: 右侧菜单控制器，可为nil
    /// - Returns: self
    @objc open class func container(centerViewController: UIViewController?, centerLeftPanViewWidth: CGFloat, centerRightPanViewWidth: CGFloat, leftMenuViewController: UIViewController?, rightMenuViewController: UIViewController?) -> SideMenuContainerViewController {
        
        let menuContainerViewController = SideMenuContainerViewController()
...
extension SideMenuContainerViewController {
    ...
    ///   - state: 状态
    ///   - completeBlock: 回调
    @objc public func setSideMenuState(state: SideMenuState, completeBlock: (SideMenuVoidBlock?) = nil) {
        ...
        let innerCompleteBlock = { [weak self] in
            ...
            let eventType: SideMenuStateEvent = (strongSelf.sideMenuState == .closed) ? .didClose : .didOpen
    ...
    private func closeSideMenu(completeBolck: (SideMenuVoidBlock?) = nil) {
    ...
    private func openLeftSideMenu(completeBolck: (SideMenuVoidBlock?) = nil) {
    ...
    private func openRightSideMenu(completeBolck: (SideMenuVoidBlock?) = nil) {
    ...
    @objc public func toggleLeftSideMenu(completeBolck: (SideMenuVoidBlock?) = nil) {
    ...
    ///
    /// - Parameter completeBolck: 完成回调
    @objc public func toggleRightSideMenu(completeBolck: (SideMenuVoidBlock?) = nil) {
...
extension SideMenuContainerViewController {
    ...
    private func setCenterViewControllerOffset(offset: CGFloat, animated: Bool, completeBlock: (SideMenuVoidBlock?) = nil) {
    ...
    private func setCenterViewControllerOffset(offset: CGFloat, additionalAnimationsBlock: (SideMenuVoidBlock?) = nil, animated: Bool, completeBlock: (SideMenuVoidBlock?) = nil) {
    ...
    private func sendStateEventNotification(event: SideMenuStateEvent) {
        ...
        NotificationCenter.default.post(name: NSNotification.Name(rawValue: SideMenuStateNotificationEvent), object: self, userInfo: userInfo)
