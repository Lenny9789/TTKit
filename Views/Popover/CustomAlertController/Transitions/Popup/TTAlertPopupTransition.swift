...
class TTAlertPopupTransition: NSObject {

    // MARK: - Declarations
    @objc public enum TTAlertPopupTransitionType : Int {
        case present = 0
        case dismiss
    }
    ...
    // MARK: - Variables
    // MARK: Public
    public var transitionType = TTAlertPopupTransitionType(rawValue: 0)
    ...
    public override init() {
        ...
        transitionType = TTAlertPopupTransitionType(rawValue: 0)
    }
}


// MARK: - UIViewControllerTransitioningDelegate
extension TTAlertPopupTransition: UIViewControllerTransitioningDelegate {
...
extension TTAlertPopupTransition: UIViewControllerAnimatedTransitioning   {
...
//        toViewController?.beginAppearanceTransition(true, animated: true)
        if transitionType == .present {
            ...
            /** HIDE ANIMATION **/
            let alertViewController: TTAlertViewController? = (fromViewController as? TTAlertViewController)
