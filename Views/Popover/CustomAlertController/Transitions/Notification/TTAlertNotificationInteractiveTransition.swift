...
class TTAlertNotificationInteractiveTransition: TTAlertBaseInteractiveTransition {
    ...
    public override func classForGestureRecognizer() -> TTAlertBaseTransitionGestureRecognizer.Type {
        return TTAlertNotificationTransitionGestureRecognizer.self
    }
...
//        let containerView = transitionContext.containerView
        ...
        if let alertViewController = viewController as? TTAlertViewController {
            
            if let alertContainerView = alertViewController.containerView   {
                
                // Slide Container View
                let currentTopOffset = TTAlertBaseInteractiveTransition.valueBetween(start: -alertContainerView.frame.size.height,
                                                                                     andEnd: 0.0,
...
extension TTAlertNotificationInteractiveTransition  {
